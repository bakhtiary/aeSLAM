...
//		return 1;
	...
	cout << "looing at this folder for the images to be processed:\n"<< dir << endl;


	VisualOdometryMono::parameters param1;
	{
	...
	VisualOdometryMono::parameters param2;
	{
	...
	VisualOdometryMono::parameters param = param1;
